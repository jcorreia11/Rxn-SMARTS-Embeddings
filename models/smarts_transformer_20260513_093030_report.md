...
**Date:** 2026-05-14  
**Run ID:** `smarts_transformer_20260513_093030`
...
| Metric | Value |
|--------|-------|
| Initial train loss | 1.7423 |
| Final train loss | 0.0494 |
| Best train loss | 0.0492 (epoch 98) |
| Final val loss | 0.0391 |
| Best val loss | 0.0383 (epoch 98) |
| Final top-1 accuracy | 98.81% |
| Best top-1 accuracy | 98.83% (epoch 93) |
| Final top-5 accuracy | 99.89% |
| Best top-5 accuracy | 99.90% (epoch 98) |

![Training loss curve](models/smarts_transformer_20260513_093030_training_loss.pdf)
