...
**Date:** 2026-07-15  
**Run ID:** `smarts_transformer_20260715_140920`
...
| Metric | Value |
|--------|-------|
| Initial train loss | 3.0870 |
| Final train loss | 0.1715 |
| Best train loss | 0.1710 (epoch 94) |
| Final val loss | 0.1387 |
| Best val loss | 0.1371 (epoch 96) |
| Final top-1 accuracy | 96.26% |
| Best top-1 accuracy | 96.26% (epoch 100) |
| Final top-5 accuracy | 99.48% |
| Best top-5 accuracy | 99.50% (epoch 95) |

![Training loss curve](models/smarts_transformer_20260715_140920_training_loss.pdf)
