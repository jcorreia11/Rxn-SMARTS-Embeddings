...
**Date:** 2026-07-16  
**Run ID:** `smarts_transformer_20260715_214441`
...
| Metric | Value |
|--------|-------|
| Initial train loss | 3.1078 |
| Final train loss | 0.1607 |
| Best train loss | 0.1603 (epoch 98) |
| Final val loss | 0.1307 |
| Best val loss | 0.1295 (epoch 88) |
| Final top-1 accuracy | 96.46% |
| Best top-1 accuracy | 96.50% (epoch 93) |
| Final top-5 accuracy | 99.57% |
| Best top-5 accuracy | 99.57% (epoch 100) |

![Training loss curve](models/smarts_transformer_20260715_214441_training_loss.pdf)
