...
**Date:** 2026-07-15  
**Run ID:** `smarts_transformer_20260715_110917`
...
| Metric | Value |
|--------|-------|
| Initial train loss | 3.0222 |
| Final train loss | 0.1763 |
| Best train loss | 0.1756 (epoch 96) |
| Final val loss | 0.1427 |
| Best val loss | 0.1399 (epoch 96) |
| Final top-1 accuracy | 96.10% |
| Best top-1 accuracy | 96.18% (epoch 96) |
| Final top-5 accuracy | 99.47% |
| Best top-5 accuracy | 99.49% (epoch 93) |

![Training loss curve](models/smarts_transformer_20260715_110917_training_loss.pdf)
