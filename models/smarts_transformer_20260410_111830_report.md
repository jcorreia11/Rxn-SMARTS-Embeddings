...
**Date:** 2026-04-10  
**Run ID:** `smarts_transformer_20260410_111830`
...
| Metric | Value |
|--------|-------|
| Initial train loss | 3.0595 |
| Final train loss | 0.1688 |
| Best train loss | 0.1688 (epoch 100) |
| Final val loss | 0.1216 |
| Best val loss | 0.1216 (epoch 100) |
| Final top-1 accuracy | 96.35% |
| Best top-1 accuracy | 96.35% (epoch 100) |
| Final top-5 accuracy | 99.54% |
| Best top-5 accuracy | 99.55% (epoch 99) |

![Training loss curve](models/smarts_transformer_20260410_111830_training_loss.pdf)
