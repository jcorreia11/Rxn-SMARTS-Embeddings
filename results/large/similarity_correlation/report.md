...
|--------|-------|---------|
| Pearson $r$ | 0.5743 | < 1e-300 |
| Spearman $\rho$ | 0.5635 | < 1e-300 |
| Pairs | 4,498,500 | — |
...
![Embedding vs structural similarity](results/large/similarity_correlation/figure.pdf)
...
Across **4,498,500** reaction pairs, the Pearson correlation between embedding cosine similarity and structural Tanimoto similarity is **r = 0.574** (Spearman ρ = 0.563), indicating a **moderate** positive relationship.
