...
**Date:** 2026-04-29  
**Run ID:** `ec_classifier_20260429_105742`
...
| Embedding extraction (pretrained) | 18.6 s (49884 sequences) |
| Embedding extraction (random-init) | 17.1 s (49884 sequences) |
...
|--------|----------|----------|-------------|-------------|--------------|
| SmartsTokenizer | 0.2493 ± 0.0079 | 0.1481 ± 0.0106 | 0.2709 ± 0.0075 | 25.2 | 26.1 |
| SentencePieceTokenizer | 0.3169 ± 0.0064 | 0.1875 ± 0.0105 | 0.3348 ± 0.0055 | 26.7 | 26.6 |
| Pretrained+logreg | 0.5632 ± 0.0067 | 0.3941 ± 0.0206 | 0.5779 ± 0.0061 | 71.4 | 452.8 |
| Random+logreg | 0.2476 ± 0.0071 | 0.1347 ± 0.0116 | 0.2694 ± 0.0060 | 125.9 | 573.0 |
| Pretrained+mlp | **0.6986 ± 0.0065** | **0.4279 ± 0.0200** | **0.6904 ± 0.0058** | 39.3 | 44.6 |
| Random+mlp | 0.4832 ± 0.0072 | 0.2023 ± 0.0127 | 0.4685 ± 0.0058 | 36.1 | 26.3 |

![EC classification comparison](results/ec_classifier_20260429_105742_report.pdf)
...
|----------|------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
| EC 1 ★ | Oxidoreductases | 14 | 0.042 | 0.143 | 0.065 | 0.038 | 0.143 | 0.061 | 0.167 | 0.429 | 0.240 | 0.043 | 0.143 | 0.066 | 0.600 | 0.429 | 0.500 | 0.111 | 0.071 | 0.087 |
| EC 2 | Transferases | 478 | 0.480 | 0.025 | 0.048 | 0.500 | 0.034 | 0.063 | 0.776 | 0.268 | 0.398 | 0.575 | 0.048 | 0.089 | 0.713 | 0.722 | 0.717 | 0.466 | 0.412 | 0.437 |
| EC 3 ★ | Hydrolases | 2 | 0.067 | 1.000 | 0.125 | 0.118 | 1.000 | 0.210 | 0.250 | 1.000 | 0.400 | 0.125 | 0.500 | 0.200 | 0.250 | 0.500 | 0.333 | 0.000 | 0.000 | 0.000 |
| EC 5 ★ | Isomerases | 4 | 0.042 | 0.250 | 0.071 | 1.000 | 0.250 | 0.400 | 0.333 | 0.500 | 0.400 | 0.143 | 0.250 | 0.182 | 1.000 | 0.250 | 0.400 | 0.000 | 0.000 | 0.000 |
| EC 6 ★ | Ligases | 4 | 0.075 | 0.750 | 0.136 | 0.143 | 0.750 | 0.240 | 0.231 | 0.750 | 0.353 | 0.158 | 0.750 | 0.261 | 0.500 | 0.500 | 0.500 | 0.500 | 0.750 | 0.600 |
...
- **Pretraining gain (logreg)**: pretrained embeddings achieve accuracy 0.5632 vs random-init 0.2476 (Δ acc = +0.3156; Δ F1 macro = +0.2594). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Pretraining gain (mlp)**: pretrained embeddings achieve accuracy 0.6986 vs random-init 0.4832 (Δ acc = +0.2154; Δ F1 macro = +0.2256). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
