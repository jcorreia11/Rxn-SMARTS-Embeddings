...
**Date:** 2026-05-14  
**Run ID:** `ec_classifier_20260514_120041`
...
| Embedding extraction (pretrained) | 37.2 s (49884 sequences) |
| Embedding extraction (random-init) | 36.8 s (49884 sequences) |
...
|--------|----------|----------|-------------|-------------|--------------|
| SmartsTokenizer | 0.2493 ± 0.0079 | 0.1481 ± 0.0106 | 0.2709 ± 0.0075 | 24.8 | 27.0 |
| SentencePieceTokenizer | 0.3169 ± 0.0064 | 0.1875 ± 0.0105 | 0.3348 ± 0.0055 | 27.2 | 28.6 |
| Pretrained+logreg | 0.7251 ± 0.0042 | **0.5586 ± 0.0173** | 0.7314 ± 0.0042 | 116.3 | 193.7 |
| Random+logreg | 0.3122 ± 0.0066 | 0.1707 ± 0.0115 | 0.3351 ± 0.0074 | 207.1 | 498.8 |
| Pretrained+mlp | **0.7801 ± 0.0051** | 0.5460 ± 0.0222 | **0.7745 ± 0.0055** | 46.4 | 33.9 |
| Random+mlp | 0.4906 ± 0.0082 | 0.2010 ± 0.0179 | 0.4743 ± 0.0096 | 41.0 | 27.8 |

![EC classification comparison](results/ec_classifier_20260514_120041_report.pdf)
...
|----------|------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
| EC 1 ★ | Oxidoreductases | 14 | 0.042 | 0.143 | 0.065 | 0.038 | 0.143 | 0.061 | 0.381 | 0.571 | 0.457 | 0.127 | 0.500 | 0.203 | 0.700 | 0.500 | 0.583 | 0.000 | 0.000 | 0.000 |
| EC 2 | Transferases | 478 | 0.480 | 0.025 | 0.048 | 0.500 | 0.034 | 0.063 | 0.869 | 0.623 | 0.726 | 0.619 | 0.109 | 0.185 | 0.846 | 0.818 | 0.832 | 0.380 | 0.540 | 0.446 |
| EC 3 ★ | Hydrolases | 2 | 0.067 | 1.000 | 0.125 | 0.118 | 1.000 | 0.210 | 0.333 | 1.000 | 0.500 | 0.000 | 0.000 | 0.000 | 0.333 | 1.000 | 0.500 | 0.000 | 0.000 | 0.000 |
| EC 5 ★ | Isomerases | 4 | 0.042 | 0.250 | 0.071 | 1.000 | 0.250 | 0.400 | 1.000 | 0.500 | 0.667 | 0.200 | 0.250 | 0.222 | 1.000 | 0.500 | 0.667 | 0.500 | 0.250 | 0.333 |
| EC 6 ★ | Ligases | 4 | 0.075 | 0.750 | 0.136 | 0.143 | 0.750 | 0.240 | 0.375 | 0.750 | 0.500 | 0.231 | 0.750 | 0.353 | 0.429 | 0.750 | 0.545 | 0.500 | 0.500 | 0.500 |
...
- **Best method**: Pretrained+mlp (accuracy 0.7801 ± 0.0051, F1 macro 0.5460 ± 0.0222).
- **Pretraining gain (logreg)**: pretrained embeddings achieve accuracy 0.7251 vs random-init 0.3122 (Δ acc = +0.4129; Δ F1 macro = +0.3879). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Pretraining gain (mlp)**: pretrained embeddings achieve accuracy 0.7801 vs random-init 0.4906 (Δ acc = +0.2895; Δ F1 macro = +0.3450). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Embeddings vs TF-IDF**: best pretrained embedding method (Pretrained+mlp, 0.7801) vs best TF-IDF baseline (SentencePieceTokenizer, 0.3169) (Δ acc = +0.4632).
