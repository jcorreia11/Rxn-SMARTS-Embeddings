...
**Date:** 2026-05-13  
**Run ID:** `ec_classifier_20260513_194406`
...
| Random seed | 42 |
| Total experiment time | 1h 14m 36s |
...
| Embedding extraction (pretrained) | 18.1 s (49884 sequences) |
| Embedding extraction (random-init) | 17.4 s (49884 sequences) |
...
|--------|----------|----------|-------------|-------------|--------------|
| SmartsTokenizer | 0.2493 ± 0.0079 | 0.1481 ± 0.0106 | 0.2709 ± 0.0075 | 25.9 | 39.4 |
| SentencePieceTokenizer | 0.3169 ± 0.0064 | 0.1875 ± 0.0105 | 0.3348 ± 0.0055 | 28.4 | 42.0 |
| Pretrained+logreg | 0.5632 ± 0.0067 | 0.3941 ± 0.0206 | 0.5779 ± 0.0061 | 80.8 | 883.8 |
| Random+logreg | 0.2475 ± 0.0068 | 0.1360 ± 0.0129 | 0.2703 ± 0.0055 | 149.7 | 1738.4 |
| Pretrained+mlp | **0.6986 ± 0.0065** | **0.4279 ± 0.0200** | **0.6904 ± 0.0058** | 43.2 | 1281.8 |
| Random+mlp | 0.4761 ± 0.0113 | 0.1895 ± 0.0153 | 0.4581 ± 0.0109 | 33.3 | 86.4 |

![EC classification comparison](results/ec_classifier_20260513_194406_report.pdf)
...
|----------|------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
| EC 1 ★ | Oxidoreductases | 14 | 0.042 | 0.143 | 0.065 | 0.038 | 0.143 | 0.061 | 0.167 | 0.429 | 0.240 | 0.048 | 0.214 | 0.079 | 0.600 | 0.429 | 0.500 | 0.400 | 0.143 | 0.210 |
| EC 2 | Transferases | 478 | 0.480 | 0.025 | 0.048 | 0.500 | 0.034 | 0.063 | 0.776 | 0.268 | 0.398 | 0.489 | 0.046 | 0.084 | 0.713 | 0.722 | 0.717 | 0.453 | 0.494 | 0.472 |
| EC 3 ★ | Hydrolases | 2 | 0.067 | 1.000 | 0.125 | 0.118 | 1.000 | 0.210 | 0.250 | 1.000 | 0.400 | 0.167 | 0.500 | 0.250 | 0.250 | 0.500 | 0.333 | 0.000 | 0.000 | 0.000 |
| EC 5 ★ | Isomerases | 4 | 0.042 | 0.250 | 0.071 | 1.000 | 0.250 | 0.400 | 0.333 | 0.500 | 0.400 | 0.111 | 0.250 | 0.154 | 1.000 | 0.250 | 0.400 | 1.000 | 0.250 | 0.400 |
| EC 6 ★ | Ligases | 4 | 0.075 | 0.750 | 0.136 | 0.143 | 0.750 | 0.240 | 0.231 | 0.750 | 0.353 | 0.167 | 0.750 | 0.273 | 0.500 | 0.500 | 0.500 | 0.333 | 0.500 | 0.400 |
...
- **Best method**: Pretrained+mlp (accuracy 0.6986 ± 0.0065, F1 macro 0.4279 ± 0.0200).
- **Pretraining gain (logreg)**: pretrained embeddings achieve accuracy 0.5632 vs random-init 0.2475 (Δ acc = +0.3157; Δ F1 macro = +0.2581). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Pretraining gain (mlp)**: pretrained embeddings achieve accuracy 0.6986 vs random-init 0.4761 (Δ acc = +0.2225; Δ F1 macro = +0.2384). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Embeddings vs TF-IDF**: best pretrained embedding method (Pretrained+mlp, 0.6986) vs best TF-IDF baseline (SentencePieceTokenizer, 0.3169) (Δ acc = +0.3817).
