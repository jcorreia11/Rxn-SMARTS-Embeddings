...
| Embedding extraction (both poolings) | 13.3 s |
| Total experiment time | 45m 45s |
...
|--------|---------|------|----------|----------|-------------|-------------|
| CLS+logreg | CLS | logreg | 0.5924 ± 0.0099 | 0.4741 ± 0.0484 | 0.6175 ± 0.0093 | 1116.0 |
| CLS+mlp | CLS | mlp | 0.7367 ± 0.0124 | 0.5837 ± 0.0538 | 0.7322 ± 0.0134 | 69.44 |
| Mean+logreg | MEAN | logreg | 0.6709 ± 0.0111 | 0.5557 ± 0.0519 | 0.6881 ± 0.0102 | 1124.55 |
| Mean+mlp | MEAN | mlp | **0.7959 ± 0.0102** | **0.6464 ± 0.0490** | **0.7934 ± 0.0095** | 123.53 |

![Pooling ablation](results/small/pooling_ablation/report.pdf)
