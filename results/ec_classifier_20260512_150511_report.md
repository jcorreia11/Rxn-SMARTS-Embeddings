...
**Date:** 2026-05-12  
**Run ID:** `ec_classifier_20260512_150511`
...
| Embedding extraction (pretrained) | 17.7 s (49884 sequences) |
...
|--------|----------|----------|-------------|-------------|--------------|
| SmartsTokenizer | 0.2493 ± 0.0079 | 0.1481 ± 0.0106 | 0.2709 ± 0.0075 | 26.3 | 28.7 |
| SentencePieceTokenizer | 0.3169 ± 0.0064 | 0.1875 ± 0.0105 | 0.3348 ± 0.0055 | 28.9 | 27.4 |
| Pretrained+logreg | 0.5632 ± 0.0067 | 0.3941 ± 0.0206 | 0.5779 ± 0.0061 | 76.0 | 163.9 |
| Random+logreg | 0.2518 ± 0.0075 | 0.1376 ± 0.0114 | 0.2758 ± 0.0074 | 104.6 | 216.3 |
| Pretrained+mlp | **0.6986 ± 0.0065** | **0.4279 ± 0.0200** | **0.6904 ± 0.0058** | 35.0 | 33.6 |
| Random+mlp | 0.4858 ± 0.0073 | 0.1977 ± 0.0188 | 0.4675 ± 0.0066 | 28.4 | 17.0 |

![EC classification comparison](results/ec_classifier_20260512_150511_report.pdf)
...
|----------|------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
| EC 1 ★ | Oxidoreductases | 14 | 0.042 | 0.143 | 0.065 | 0.038 | 0.143 | 0.061 | 0.167 | 0.429 | 0.240 | 0.064 | 0.286 | 0.104 | 0.600 | 0.429 | 0.500 | 0.273 | 0.214 | 0.240 |
| EC 2 | Transferases | 478 | 0.480 | 0.025 | 0.048 | 0.500 | 0.034 | 0.063 | 0.776 | 0.268 | 0.398 | 0.500 | 0.042 | 0.077 | 0.713 | 0.722 | 0.717 | 0.433 | 0.450 | 0.441 |
| EC 3 ★ | Hydrolases | 2 | 0.067 | 1.000 | 0.125 | 0.118 | 1.000 | 0.210 | 0.250 | 1.000 | 0.400 | 0.000 | 0.000 | 0.000 | 0.250 | 0.500 | 0.333 | 0.000 | 0.000 | 0.000 |
| EC 5 ★ | Isomerases | 4 | 0.042 | 0.250 | 0.071 | 1.000 | 0.250 | 0.400 | 0.333 | 0.500 | 0.400 | 0.333 | 0.250 | 0.286 | 1.000 | 0.250 | 0.400 | 1.000 | 0.250 | 0.400 |
| EC 6 ★ | Ligases | 4 | 0.075 | 0.750 | 0.136 | 0.143 | 0.750 | 0.240 | 0.231 | 0.750 | 0.353 | 0.143 | 0.750 | 0.240 | 0.500 | 0.500 | 0.500 | 0.286 | 0.500 | 0.364 |
...
- **Pretraining gain (logreg)**: pretrained embeddings achieve accuracy 0.5632 vs random-init 0.2518 (Δ acc = +0.3114; Δ F1 macro = +0.2565). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Pretraining gain (mlp)**: pretrained embeddings achieve accuracy 0.6986 vs random-init 0.4858 (Δ acc = +0.2128; Δ F1 macro = +0.2302). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
