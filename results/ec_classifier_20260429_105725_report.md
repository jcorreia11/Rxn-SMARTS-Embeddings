...
**Date:** 2026-04-29  
**Run ID:** `ec_classifier_20260429_105725`
...
| Embedding extraction (pretrained) | 17.4 s (49962 sequences) |
| Embedding extraction (random-init) | 17.2 s (49962 sequences) |
...
|--------|----------|----------|-------------|-------------|--------------|
| SmartsTokenizer | 0.3979 ± 0.0059 | 0.2373 ± 0.0167 | 0.4216 ± 0.0070 | 15.5 | 42.3 |
| SentencePieceTokenizer | 0.4617 ± 0.0083 | 0.2918 ± 0.0233 | 0.4867 ± 0.0087 | 17.6 | 39.7 |
| Pretrained+logreg | 0.6182 ± 0.0090 | 0.4371 ± 0.0235 | 0.6353 ± 0.0079 | 37.4 | 743.8 |
| Random+logreg | 0.3330 ± 0.0076 | 0.1803 ± 0.0125 | 0.3581 ± 0.0081 | 69.9 | 1829.0 |
| Pretrained+mlp | **0.7542 ± 0.0063** | **0.5208 ± 0.0286** | **0.7515 ± 0.0058** | 79.5 | 37.6 |
| Random+mlp | 0.5356 ± 0.0088 | 0.2588 ± 0.0160 | 0.5242 ± 0.0099 | 37.4 | 24.4 |

![EC classification comparison](results/ec_classifier_20260429_105725_report.pdf)
...
|----------|------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
| EC 1 | Oxidoreductases | 559 | 0.526 | 0.181 | 0.269 | 0.581 | 0.276 | 0.374 | 0.715 | 0.449 | 0.552 | 0.457 | 0.134 | 0.207 | 0.693 | 0.760 | 0.725 | 0.482 | 0.497 | 0.489 |
| EC 2 ★ | Transferases | 35 | 0.039 | 0.229 | 0.066 | 0.076 | 0.371 | 0.127 | 0.135 | 0.429 | 0.205 | 0.041 | 0.200 | 0.069 | 0.486 | 0.486 | 0.486 | 0.077 | 0.029 | 0.042 |
| EC 3 | Hydrolases | 64 | 0.081 | 0.188 | 0.113 | 0.140 | 0.281 | 0.186 | 0.207 | 0.516 | 0.296 | 0.099 | 0.266 | 0.145 | 0.473 | 0.406 | 0.437 | 0.289 | 0.172 | 0.216 |
| EC 5 | Isomerases | 206 | 0.392 | 0.359 | 0.375 | 0.453 | 0.519 | 0.484 | 0.554 | 0.568 | 0.561 | 0.324 | 0.330 | 0.327 | 0.757 | 0.665 | 0.708 | 0.471 | 0.466 | 0.468 |
| EC 6 | Ligases | 980 | 0.680 | 0.089 | 0.157 | 0.732 | 0.201 | 0.316 | 0.831 | 0.412 | 0.551 | 0.547 | 0.076 | 0.134 | 0.712 | 0.761 | 0.736 | 0.446 | 0.584 | 0.505 |
...
- **Pretraining gain (logreg)**: pretrained embeddings achieve accuracy 0.6182 vs random-init 0.3330 (Δ acc = +0.2852; Δ F1 macro = +0.2568). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Pretraining gain (mlp)**: pretrained embeddings achieve accuracy 0.7542 vs random-init 0.5356 (Δ acc = +0.2186; Δ F1 macro = +0.2620). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
