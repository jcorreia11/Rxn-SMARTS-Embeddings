...
**Date:** 2026-05-13  
**Run ID:** `ec_classifier_20260513_190834`
...
| Embedding extraction (pretrained) | 18.2 s (49962 sequences) |
| Embedding extraction (random-init) | 17.4 s (49962 sequences) |
...
|--------|----------|----------|-------------|-------------|--------------|
| SmartsTokenizer | 0.3979 ± 0.0059 | 0.2373 ± 0.0167 | 0.4216 ± 0.0070 | 15.2 | 28.6 |
| SentencePieceTokenizer | 0.4617 ± 0.0083 | 0.2918 ± 0.0233 | 0.4867 ± 0.0087 | 16.8 | 29.9 |
| Pretrained+logreg | 0.6182 ± 0.0090 | 0.4371 ± 0.0235 | 0.6353 ± 0.0079 | 34.8 | 297.5 |
| Random+logreg | 0.3430 ± 0.0059 | 0.1916 ± 0.0155 | 0.3669 ± 0.0068 | 53.6 | 493.0 |
| Pretrained+mlp | **0.7542 ± 0.0063** | **0.5208 ± 0.0286** | **0.7515 ± 0.0058** | 84.0 | 20.8 |
| Random+mlp | 0.5417 ± 0.0053 | 0.2684 ± 0.0278 | 0.5285 ± 0.0062 | 57.8 | 22.1 |

![EC classification comparison](results/ec_classifier_20260513_190834_report.pdf)
...
|----------|------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
| EC 1 | Oxidoreductases | 559 | 0.526 | 0.181 | 0.269 | 0.581 | 0.276 | 0.374 | 0.715 | 0.449 | 0.552 | 0.453 | 0.145 | 0.220 | 0.693 | 0.760 | 0.725 | 0.425 | 0.556 | 0.482 |
| EC 2 ★ | Transferases | 35 | 0.039 | 0.229 | 0.066 | 0.076 | 0.371 | 0.127 | 0.135 | 0.429 | 0.205 | 0.054 | 0.257 | 0.089 | 0.486 | 0.486 | 0.486 | 0.200 | 0.086 | 0.120 |
| EC 3 | Hydrolases | 64 | 0.081 | 0.188 | 0.113 | 0.140 | 0.281 | 0.186 | 0.207 | 0.516 | 0.296 | 0.079 | 0.172 | 0.108 | 0.473 | 0.406 | 0.437 | 0.241 | 0.109 | 0.150 |
| EC 5 | Isomerases | 206 | 0.392 | 0.359 | 0.375 | 0.453 | 0.519 | 0.484 | 0.554 | 0.568 | 0.561 | 0.396 | 0.369 | 0.382 | 0.757 | 0.665 | 0.708 | 0.573 | 0.384 | 0.459 |
| EC 6 | Ligases | 980 | 0.680 | 0.089 | 0.157 | 0.732 | 0.201 | 0.316 | 0.831 | 0.412 | 0.551 | 0.561 | 0.085 | 0.147 | 0.712 | 0.761 | 0.736 | 0.446 | 0.580 | 0.504 |
...
- **Pretraining gain (logreg)**: pretrained embeddings achieve accuracy 0.6182 vs random-init 0.3430 (Δ acc = +0.2752; Δ F1 macro = +0.2455). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
- **Pretraining gain (mlp)**: pretrained embeddings achieve accuracy 0.7542 vs random-init 0.5417 (Δ acc = +0.2125; Δ F1 macro = +0.2524). Positive gain confirms that MLM pretraining encodes reaction-type information beyond random projection.
